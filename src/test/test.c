...
static int dummy_mkdir(struct lwp *,
                       const struct sys_mkdir_args *, register_t *);
...
static int dummy_mkdir(struct lwp *lp,
                       const struct sys_mkdir_args *ap, register_t *rp) {
